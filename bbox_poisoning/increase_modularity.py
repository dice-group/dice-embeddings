...
# ----------------------------------------------
# 3) Heuristic: increase modularity, reduce C(G)
# ----------------------------------------------
...
def improve_modularity_reduce_clustering(
    ...
    budget : int
        Maximum number of accepted rewiring operations.
    max_candidates_per_step : int
        Maximum number of candidate edges to test per step (for efficiency).
    seed : int or None
    ...
    history : list of dict
        List of metrics over accepted steps:
        [{"step": ..., "Q": ..., "C": ...}, ...]
    """
...
if __name__ == "__main__":
    ...
    path = f"./KGs/{DB}/train.txt"   # change to your file
