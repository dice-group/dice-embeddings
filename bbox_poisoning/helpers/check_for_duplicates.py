...
dups = find_duplicate_triples(
    "saved_models/old/without_recipriocal/UMLS/active_poisoning_whitebox/Pykeen_MuRE/adverserial_fgsm_triples/521/random-one/0/train.txt")
if dups:
    for t, c in dups:
