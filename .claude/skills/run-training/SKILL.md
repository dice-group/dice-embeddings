---
name: run-training
description: Configure and launch KGE model training in dicee. Use when training a KGE model, choosing a trainer backend, selecting a scoring technique, setting up multi-GPU/DDP/FSDP training, using weight averaging (SWA/EMA/SWAG), configuring periodic evaluation, or resuming training with continual learning.
---
