...
class QMult(BaseKGE):
    def __init__(self, args):
        ...
        self.bn_ent_i = torch.nn.LayerNorm(self.embedding_dim)
        self.bn_ent_j = torch.nn.LayerNorm(self.embedding_dim)
        self.bn_ent_k = torch.nn.LayerNorm(self.embedding_dim)
        # Batch normalization for quaternion embeddings of relations.
        self.bn_rel_real = torch.nn.LayerNorm(self.embedding_dim)
        self.bn_rel_i = torch.nn.LayerNorm(self.embedding_dim)
        self.bn_rel_j = torch.nn.LayerNorm(self.embedding_dim)
        self.bn_rel_k = torch.nn.LayerNorm(self.embedding_dim)

        # Batch normalization for quaternion embeddings of relations.
        self.bn_hidden_real = torch.nn.LayerNorm(self.embedding_dim)
        self.bn_hidden_i = torch.nn.LayerNorm(self.embedding_dim)
        self.bn_hidden_j = torch.nn.LayerNorm(self.embedding_dim)
        self.bn_hidden_k = torch.nn.LayerNorm(self.embedding_dim)
