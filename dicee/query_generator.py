        ...
        for path in paths:
            ...
            with open(path, "r") as f:
                for line in f:
                    ...
                    try:
                        # Skip if any token is a pure string literal (starts and ends with quotes)
                        ...
                        print(f"Invalid line format, expected at least 4 elements but got {len(tokens)}: {line}")
                        continue
