...
def sanity_checking_with_arguments(args):
    ...
    assert args.scoring_technique in ["AllvsAll", "1vsSample", "KvsSample","KvsAll", "NegSample", "1vsAll","Pyke", "Sentence", "ByteGen"], f"Invalid training strategy => {args.scoring_technique}."
