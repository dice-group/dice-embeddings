...
class Evaluator:
   ...
   """
    ...
    def evaluate_bpe_lp(self, model, triple_idx, ordered_bpe_entities_relations, info):
        ...
        return evaluate_bpe_lp(model, triple_idx, ordered_bpe_entities_relations, er_vocab=self.er_vocab, re_vocab=self.re_vocab, info=info)
