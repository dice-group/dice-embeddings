...
def evaluate_lp(model, triple_idx, num_entities, er_vocab:Dict[Tuple,List], re_vocab:Dict[Tuple,List], info='Eval Starts'):
    """
...
def _evaluate_lp(model, triple_idx, num_entities: int, er_vocab:Dict[Tuple,List], re_vocab:Dict[Tuple,List], info='Eval Starts'):
